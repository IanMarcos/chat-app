...
function DefaultView() {
  ...
  const me =
    "https://github.com/IanMarcos/personal-assets/blob/main/cv-app/ME.png?raw=true";
  const rn =
    "https://github.com/IanMarcos/personal-assets/blob/main/cv-app/RN.png?raw=true";
  ...
  function Slide({ info, slideStyle }) {
    ...
    return <div className={`${styles.presentation} ${slideStyle}`}>{info}</div>;
  }
